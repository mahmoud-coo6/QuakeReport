...
//    EarthquckAskTask task=new EarthquckAskTask();
//    task.execute("https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2016-01-01&endtime=2016-05-02&minfelt=50&minmagnitude=5");
    ...
    class EarthquckAskTask extends AsyncTask<String,Void,List<Earthquake>>{
